...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .to('#claim', { duration: 0.5, x: -373, y: -26, scale: 0.713, ease: 'elastic(1,.85)' }, TL.setCurTime('screen2', 0))
    .to('#claim1', { duration: 0.5, x: -203, y: -125, scale: 0.638, ease: 'elastic(1,.85)' }, TL.setCurTime('screen2', 0.1))
    .from('#tel', { duration: 0.8, y: 250, ease: 'power3.out' }, TL.setCurTime('screen2', 0.4))
    ...
    .to('#tel', { duration: 0.6, x: 93, ease: 'elastic.in(1,.85)' }, TL.setCurTime('screen3', 0))
    ...
    .from('#telf', { duration: 0.8, y: 250, ease: 'power3.out' }, TL.setCurTime('screen5', 0.4))
     ...
     *
     */
    .call(TL.testEnd.bind(TL), ['main', true, null, null, true], TL.setCurTime('screen5', 3.8));
});
