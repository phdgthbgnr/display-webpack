...
document.addEventListener('loaded', (e) => {
  ...
  const o = { id: 'maskintro', props: { x: 0, opacity: 1 } };
  ...
  TL.timelines.main
     ...
     * ecran 1
     */
    .from(o.props, { duration: 0.3, opacity: 0 }, TL.setCurTime('screen1', 2))
    // .call(CSS.addClass, ['#CTA', 'invert'], TL.setCurTime('screen1', 1))
    // .from('#CTA', { duration: 1, blur: 20 }, TL.setCurTime('screen1', 1))
    /**
     * ecran 2
     */
    .to(o.props, { duration: 0.3, x: 50 }, TL.setCurTime('screen2', 4))
    /**
     * ecran 3
     */
    .to(o.props, { duration: 0.3, x: 0 }, TL.setCurTime('screen3', 6))
    /**
     * ecran 4
     */
    .to(o.props, { duration: 0.3, x: 0 }, TL.setCurTime('screen4', 8))
    // .call(TL.testLoopEnd.bind(TL), ['main', 2, true], TL.setCurTime('screen4', 2))
    /**
     * ecran 5
     */
    .to(o.props, { duration: 0.3, x: 0 }, TL.setCurTime('screen5', 10))
