...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('.prods', { duration: 1, xPercent: 80, ease: 'sine.inOut', stagger: 0.05 }, TL.setCurTime('screen1', 0))
    ...
    .from('#vectos', { duration: 1.5, xPercent: 30, ease: 'sine.out' }, TL.setCurTime('screen1', 0))
    ...
    .from('#vahine', { duration: 2, scale: 0.95, ease: 'sine.out', transformOrigin: '50% 100%' }, TL.setCurTime('screen2', 0))
    ...
    .from('#pictos', { duration: 1, opacity: 0, y: 30, ease: 'sine.out' }, TL.setCurTime('screen3', 0.4))
    ...
    .from('.prod1f', { duration: 1, xPercent: -60, ease: 'sine.out' }, TL.setCurTime('screen4', 0.2))
    .from('.prod2f', { duration: 1, xPercent: 60, ease: 'sine.out' }, TL.setCurTime('screen4', 0.2))
