...
document.addEventListener('loaded', (e) => {
  ...
  TL.timelines.main
    ...
    .from('.visus', { duration: 0.5, opacity: 0, x: 50, ease: 'sine.out', stagger: 0.15 }, TL.setCurTime('screen1', 0))
    .from('#logo1', { duration: 0.6, scale: 0, ease: 'elastic(1,.85)' }, TL.setCurTime('screen1', 0.3))
    .from('#claim', { duration: 0.5, opacity: 0, x: -50, ease: 'sine.out' }, TL.setCurTime('screen1', 0.3))
    ...
    .to('.tel21', { duration: 1, y: -5, repeat: 10, yoyo: true, ease: 'sine.inOut' }, TL.setCurTime('screen1', 0.5))
    .to('.tel2', { duration: 1, y: -5, repeat: 10, yoyo: true, ease: 'sine.inOut' }, TL.setCurTime('screen1', 0.7))
    /**
     * ecran 2
     */
     ...
     *
     */
    .call(TL.testEnd.bind(TL), ['main', null, null, true], TL.setCurTime('screen2', 5.3));
});
